...
public class ApprovalList_delete extends  RecyclerView.Adapter<ApprovalList_delete.ViewHolder>{
    ...
    public ApprovalList_delete(List<String> nameOfUser,List<String> NameOfShopon, ArrayList<String> bid, Context con) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        ApprovalList_delete.ViewHolder holder= new ApprovalList_delete.ViewHolder (view);
        return holder;
    }
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.paerntlyout.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                Intent intent = new Intent (context, Admin_Approval_Delete.class);
